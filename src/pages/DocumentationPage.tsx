        ...
        <ReactMarkdown
          ...
          components={{
            ...
            a: ({ href, children }) => {
              ...
              return <a href={isAlgorithmReference ? '/documentation#algorithm-reference' : href} className='text-blue-400 underline underline-offset-4 hover:text-blue-300'>{children}</a>
            },
