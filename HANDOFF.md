...
**Date:** 2026-06-10
**Status:** Terrain drag-selection regression fix implemented, built, linted, deployed, and committed.
**Active task:** Push `main` after this handoff update; production deploy hash is `9b6b83f`.
