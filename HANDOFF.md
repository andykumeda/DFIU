...
**Date:** 2026-08-07
**Branch:** `main`
**Status:** Ko-fi support link configured and deployed; email follow-up remains a later phase.

> **All agents:** read `AGENTS.md` ("Mandatory Agent Workflow") before making any change.

## Current production snapshot

- Frontend: `6158197`. Ko-fi support link is included in the deployed build.
- OG: `dfiu-og` serves `og-default.png` (left) by default; Facebook/Instagram UAs get `og-ig.png` (centered).

## Just finished

- Added the Support DFIU card to Settings and About, plus a persistent footer link across the app. Configured the donation destination as `https://ko-fi.com/dfiu_`; email follow-up is deferred.
