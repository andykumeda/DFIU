...
**Date:** 2026-08-12
**Branch:** `main`
**Status:** Ask Strava intent routing is fixed and deployed; signed-in production smoke test remains.
...
- Last deployed commit: `31be045` (frontend plus `strava-activity` Edge Function).
