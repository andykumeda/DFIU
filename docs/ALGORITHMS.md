...
Relevant implementation: `src/features/race/pace-utils.ts`, `src/features/race/pace-prediction.ts`, `src/lib/training-overlap.ts`, `src/features/race/training-analysis.ts`, and `src/features/race/RaceDetail.tsx`.
