...
The **Notes** tab sits between Drop Bags and Resources. It holds timed checklists (**Todo 1 month before**, **Todo 1 week before**, **Todo night before**) and freeform Markdown sections (**Notes (Personal)**, **Notes (Crew)**, **Notes (Pacer)**).
...
Editors can add, reorder, and delete items, set visibility, and save. They can also check off todos without entering full edit mode. Each section has its own **Print** control when it has visible content. Notes use the same Markdown support as Resources. Personal notes and todos copy when you clone a race and are not overwritten by official-update sync.
