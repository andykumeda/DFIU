-- Race-level drop bag template, customizable resources, and pace chart column prefs.

ALTER TABLE races
    ADD COLUMN IF NOT EXISTS drop_bag_template jsonb,
    ADD COLUMN IF NOT EXISTS resources_config jsonb;

ALTER TABLE race_pace_plans
    ADD COLUMN IF NOT EXISTS pace_chart_columns jsonb;

-- Keep clone_race in sync with new race columns.
...
BEGIN
    ...
    INSERT INTO races (
        ...
        drop_bag_template, resources_config,
