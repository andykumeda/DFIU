...
-   **Official source protection:** Official event pages are globally shared and database-enforced as site-admin-only for every mutation; runners make all planning changes on personal clones.
